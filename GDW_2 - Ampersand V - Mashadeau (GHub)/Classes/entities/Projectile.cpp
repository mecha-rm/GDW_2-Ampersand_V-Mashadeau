...
void entity::Projectile::createWeapon(unsigned int WIN) // creates the projectile.
{
	...
	switch(this->WIN)
	{
		...
		case 11: // Null Sphere Medium
				...
				getOwner()->getSprite()->addChild(sprite); // the sprite's positon won't be saved unless this is done. This is just to ensure that the code doesn't crash from trying to get the sprite's position.
				sprite->setVisible(true);

				break;

		case 12: // Null Sphere Large
